...
def diag():
    ...
    if sg:
        ...
        print(f"  Примеры значений 'Артикул продавца': {df['Артикул продавца'].head(3).tolist() if 'Артикул продавца' in df.columns else 'нет такой колонки'}")
    ...
    if cd:
        ...
        print(f"  Колонки: {df.columns.tolist()}")
        print(f"  Примеры 'Артикул продавца': {df['Артикул продавца'].head(3).tolist() if 'Артикул продавца' in df.columns else 'нет такой колонки'}")
